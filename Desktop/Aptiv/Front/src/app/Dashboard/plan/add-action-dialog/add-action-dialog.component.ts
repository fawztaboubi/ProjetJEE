...
export class AddActionDialogComponent implements OnInit {
  ...
  constructor(private userService: UserService, private actionService: ActionService,
    ...
    //retrieving users this way is possible only if the desrialization is implemented in backend, this way a department can have a set of users
    //implementing desrialization is a little cmplicated since we have nested objects and lists of objects in department so instead
    //we're solving this in Frontend, easy
